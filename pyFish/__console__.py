...
parser.add_argument('file',	metavar='path',	type=str, help='data file to be analysed')
parser.add_argument('--delimiter', type=str, default=',', help='csv delimiter of input file')
parser.add_argument('--vector',	type=bool,nargs='?', const=True)
parser.add_argument('-x1', type=int, default=0,	help='index of first data column')
parser.add_argument('-x2', type=int, default=1,	help='index of second data column')
...
parser.add_argument('--no_fft', type=bool, nargs='?', const=False, help="use standard method instead of fft for analysis")
parser.add_argument('--drift_order', type=int, help='force drift order to a value')
parser.add_argument('--diff_order', type=int, help='force diff order to a value')
parser.add_argument('-n_trials', type=int, default=1, help='n_trials')
parser.add_argument('--show_figs', type=bool, nargs='?', const=True, help='Show figures')
parser.add_argument('--savepath', metavar='path', type=str, help='path to save the results')
